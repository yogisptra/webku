          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="carousel-item {{$loop->first ? 'active' : ''}}">
                <div class="row">
                  <div class="col-sm-5">
                    <img class="d-block w-100" src="{{asset('img/'.$kategori->avatar)}}">
                  </div>
                  <div class="col-sm-7">
                    <h2>{{$kategori->kategori_produk}}</h2>
                    <p>{{$kategori->deskripsi_produk}}</p>
                    <a href="/{{$kategori->id}}/pesan" class="btn btn-primary yess">Pesan</a>
                  </div>
                </div>
              </div>
              @endforeach
